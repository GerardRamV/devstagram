    ...
    <div class="container mx-auto md:flex">
        <div class="w-full md:w-1/2 p-5">
            ...
            <div class="p-3 flex items-center gap-4">
                ...
                {{-- <p class="font-bold">
                    {{$post->likes->count()}} 
                    <span class="font-normal">Like(s)</span>
                </p> --}}
            </div>
            <div>
                <p class="font-bold">
                ...
                <p class="mt-5"> {{-- max-h-96 overflow-y-scroll --}}
                    {{$post->descripcion}}
                </p>
            </div>
        ...
        <div class="w-full md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                @auth
                    ...
                    @if (session('mensaje'))
                        <div class="bg-green-500 p-2 rounded text-white text-center uppercase font-bold">
                            {{session('mensaje')}}
                        </div>
                    @endif
                    <form action="{{route('comentarios.store', ['post' => $post, 'user' => $user])}}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="comentario" id="comentario" placeholder="comentario de la publicacion" class="border p-3 w-full rounded-lg @error('comentario') border-red-500 @enderror"></textarea>
                            @error('comentario')
